...
import static com.example.homeworkcorrectteacher.cache.UserCache.user;
...
public class ConversationListActivity extends FragmentActivity {
    ...
    * */
    private void findUserById(final String userId) {
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                final UserInfo info= new UserInfo(userId,user.getNickname(),Uri.parse(IP.CONSTANT+"userImage/"+user.getImage()));
     ...
     * 从服务端获取教师昵称和头像
     * */
    private void findTeacherById(final String userId) {
        //请求体是普通的字符串
        //3、创建请求对象
        Request request = new Request.Builder()//调用post方法表示请求方式为post请求   put（.put）
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                final UserInfo info= new UserInfo(userId,teacher.getNickname(),Uri.parse(IP.CONSTANT+"teacherImage/"+teacher.getImage()));
                Log.e("info",info.toString());
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
