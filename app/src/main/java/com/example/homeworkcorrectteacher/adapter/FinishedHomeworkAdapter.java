...
public class FinishedHomeworkAdapter extends BaseAdapter {
    private Context mContext;
    private List<Homework> homeworks;
    private int itemLayoutRes;
    public FinishedHomeworkAdapter(Context mContext, List<Homework> homeworks, int msg_list_item) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            viewHolder.continueBtn = convertView.findViewById(R.id.detail);
